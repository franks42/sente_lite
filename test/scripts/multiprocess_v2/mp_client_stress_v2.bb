#!/usr/bin/env bb
;;
;; Multi-Process Stress Test Client (v2 using client_bb.clj)
;;
;; Usage: bb mp_client_stress_v2.bb <test-id> <client-id> <channel-id> <message-count> <interval-ms>
;;
...
(defn parse-args [args]
  (when (< (count args) 5)
    (println "Usage: bb mp_client_stress_v2.bb <test-id> <client-id> <channel-id> <message-count> <interval-ms>")
    (System/exit 1))
  {:test-id (first args)

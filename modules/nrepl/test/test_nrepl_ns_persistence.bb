...
(let [result (server/eval-code "(str *ns*)")]
...
(let [result (server/eval-code "(ns nrepl.test.myns)")]
...
(let [result (server/eval-code "(def my-test-var 42)")]
...
(let [result (server/eval-code "my-test-var")]
...
(let [result (server/eval-code "(ns nrepl.test.other)")]
...
(let [result (server/eval-code "nrepl.test.myns/my-test-var")]
